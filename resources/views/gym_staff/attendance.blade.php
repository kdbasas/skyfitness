    ...
    <div class="flex-1 ml-64 p-6 bg-[#ECE9E9]">
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg">
            ...
            <div class="flex justify-end mb-4">
                <form method="GET" action="{{ route('gym_staff.attendance') }}">
                    ...
                    @forelse($attendanceRecords as $record)
                        <tr>
                            ...
                            <td class="px-4 py-2 border-b">
                                <a href="{{ route('gym_staff.attendance.view', ['member_id' => optional($record)['member_id']]) }}" class="bg-green-500 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition duration-300 ease-in-out">
                                    View Attendance
                                </a>
                            </td>
                        </tr>
