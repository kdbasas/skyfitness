...
<div class="bg-white p-6 rounded-lg shadow-lg mb-6">
    ...
    <!-- Registration Form -->
    <form id="registrationForm" action="{{ route('gym_staff.member.add') }}" method="POST" class="space-y-4" enctype="multipart/form-data">
        @csrf
        <!-- Form Fields -->
...
<div class="bg-white p-6 rounded-lg shadow-lg">
    ...
    <div class="flex justify-between mb-4">
        <form action="{{ route('gym_staff.member_management') }}" method="GET" class="w-full md:w-1/3 flex">
        ...
        <!-- Sorting Dropdown -->
        <form action="{{ route('gym_staff.member_management') }}" method="GET" class="flex items-center ml-4">
